    ...
    <footer className="bg-gray-900 pt-16 pb-12 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 border-b border-gray-800 pb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <span className="bg-lams-orange text-white p-2 rounded-lg">
                <i className="fa-solid fa-plane-departure text-xl"></i>
              </span>
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white tracking-tight leading-none">LAMS VIAJES</span>
                <span className="text-[9px] text-lams-orange font-bold tracking-widest uppercase">Viaja Sueña Imagina</span>
              </div>
            </div>
            <p className="text-gray-400 leading-relaxed mb-6 font-light">
              Expertos en turismo personalizado. Conectamos tus sueños con los mejores destinos del mundo.
            </p>
          ...
          <div className="col-span-1">
            <h4 className="text-white font-bold mb-6 uppercase text-sm tracking-widest border-l-4 border-lams-orange pl-4">Navegación</h4>
          ...
          {/* Destinos Populares */}
          <div className="col-span-1">
            <h4 className="text-white font-bold mb-6 uppercase text-sm tracking-widest border-l-4 border-lams-navy pl-4">Top Destinos</h4>
            <ul className="space-y-4">
          ...
          {/* Newsletter */}
          <div className="col-span-1">
            <h4 className="text-white font-bold mb-6 uppercase text-sm tracking-widest border-l-4 border-lams-orange pl-4">Ofertas</h4>
            ...
            <div className="relative group">
              ...
              />
              <button className="absolute right-2 top-2 bottom-2 bg-lams-orange text-white px-3 rounded-lg hover:bg-lams-orange/90 transition-all">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm italic">
          <p>© 2024 Lams Viajes. Todos los derechos reservados.</p>
