        ...
        <div className="max-w-5xl mx-auto">
          <header className="mb-12 text-center">
            <h1 className="text-4xl font-extrabold text-lams-navy mb-4 tracking-tight">
              Mis{" "}
              <span className="text-lams-orange tracking-wide">Aventuras</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Aquí tienes un resumen de todas tus experiencias reservadas con
              Lams Viajes.
            </p>
          </header>
          ...
          {bookings.length === 0 ? (
            <div className="bg-white rounded-[2rem] shadow-xl p-16 text-center border border-gray-100">
              ...
              <p className="text-gray-500 mb-10 max-w-md mx-auto">
                Parece que todavía no has reservado ninguna aventura. ¡Es el
            ...
            <div className="grid gap-8">
              {bookings.map((booking) => (
                <div
                  key={booking.id}
                  className="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300"
                >
                  <div className="p-8 md:p-10">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-3xl font-black text-lams-orange">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 relative overflow-hidden group">
                        <div className="flex items-center space-x-3 mb-4">
                          <span className="p-2 bg-lams-orange/10 text-lams-orange rounded-lg">
                            ✈️
                          </span>
                      ...
                      {/* Servicios */}
                      <div className="bg-orange-50/50 p-6 rounded-2xl border border-orange-100 group">
                        <div className="flex items-center space-x-3 mb-4">
                        ...
                        {booking.services && booking.services.length > 0 ? (
                          <div className="space-y-2">
                            {booking.services.map((item) => (
                              <div
                                key={item.service.id}
                                className="border-b border-orange-100 pb-2"
                              >
                                <p className="text-sm font-bold text-gray-700 truncate">
                                  {item.service.name}
                                </p>
