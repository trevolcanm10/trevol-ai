        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="px-8 py-6 bg-gradient-to-r from-lams-navy to-blue-900 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h3 className="text-2xl font-bold text-white">Directorio de Clientes</h3>
                <p className="text-blue-100 mt-1">Contacta directamente a tus viajeros para cerrar ventas</p>
              </div>
              ...
              {stats.customers.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {stats.customers
                    ...
                    .map((customer, index) => (
                      <div key={index} className="bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 group">
                        <div className="flex items-center space-x-4 mb-6">
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 text-sm overflow-hidden text-ellipsis">{customer.email}</p>
                          </div>
                        </div>
                        
                        <div className="space-y-3">
                          <div className="flex items-center text-gray-600 text-sm">
                            <svg className="w-4 h-4 mr-2 text-lams-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="flex items-center text-gray-500 text-xs">
                            ...
                            <span>Registrado el {new Date(customer.created_at).toLocaleDateString()}</span>
                          </div>
                        </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200 grid grid-cols-2 gap-4">
                          ...
                          <a
                            href={customer.phone ? `https://wa.me/51${customer.phone.replace(/\s+/g, '')}?text=Hola ${encodeURIComponent(customer.name)}, te escribo de Lams Viajes sobre tu interés en viajar con nosotros.` : "#"}
                            target="_blank"
                ...
                <div className="text-center py-20">
                  ...
                  <h3 className="text-xl font-bold text-gray-800">Aún no hay clientes registrados</h3>
                  <p className="text-gray-500">Los clientes aparecerán aquí una vez creen una cuenta en la web.</p>
                </div>
              )}
            </div>
          </div>
