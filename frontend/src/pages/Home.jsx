        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10 w-full animate-fade-in">
          <div className="text-center">
            ...
            <h1 className="text-6xl md:text-8xl font-extrabold text-white mb-6 tracking-tight drop-shadow-2xl">
              LAMS{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-lams-orange to-[#f19b5c]">
                VIAJES
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed font-light drop-shadow-md">
              <span className="block text-lams-orange font-bold text-3xl mb-4 tracking-[0.3em] uppercase">
                Viaja • Sueña • Imagina
              </span>
              Encuentra el destino de tus sueños con la mejor atención
              personalizada. Diseñamos el trayecto perfecto para ti en segundos.
            </p>
          </div>
        </div>
      </div>
            ...
            return (
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-10 rounded-3xl mb-10 shadow-xl border border-gray-200">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      ...
                      <span className="font-bold text-lams-orange text-lg">
                  ...
                  <button
                    ...
                    className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 shadow-xl mt-4 md:mt-0"
                  >
                    Cancelar Todo
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  {/* Vuelo */}
                  <div
                    className={`bg-white p-5 rounded-2xl border-2 shadow-lg transition-all ${selectedFlight ? "border-blue-400" : "border-dashed border-gray-200 opacity-50"}`}
                  >
                    ...
                    {selectedFlight ? (
                      <>
                        ...
                        <p className="text-lams-orange font-bold text-sm">
                          S/. {selectedFlight.price}
                        </p>
                        <button
                  ...
                  {/* Hotel */}
                  <div
                    className={`bg-white p-5 rounded-2xl border-2 shadow-lg transition-all ${selectedHotel ? "border-green-400" : "border-dashed border-gray-200 opacity-50"}`}
                  >
                    <div className="flex items-center space-x-2 mb-2">
                    ...
                    {selectedHotel ? (
                      <>
                        ...
                        <p className="text-green-600 font-bold text-sm">
                          S/. {selectedHotel.price_per_night}/noche
                        </p>
                        <button
                  ...
                  {/* Tour Turístico */}
                  <div
                    className={`bg-white p-5 rounded-2xl border-2 shadow-lg transition-all ${selectedTour ? "border-purple-400" : "border-dashed border-gray-200 opacity-50"}`}
                  >
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-xl">🗺️</span>
                  ...
                  return (
                    <>
                      ...
                      <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-200">
                        ...
                        {showTours && (
                          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8">
                            {toursRegulares.length > 0 ? (
                              toursRegulares.map((t) => (
                                <TourCard
                                  key={t.id}
                                  tour={t}
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500">
                                  Complementa tu viaje con estos servicios
                                </p>
                              </div>
                            </div>
                            <span className="text-base font-medium text-gray-500">
                              {serviciosAdicionales.length} disponibles
                            </span>
                          </div>
            ...
            <div className="mt-20 mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                  Soluciones integrales para que tu única preocupación sea
                  disfrutar del viaje.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Asistencia médica internacional y protección 24/7.",
                    color: "blue",
                    wa: "Seguro de Viaje",
                  },
                  {
                  ...
                  <div
                    key={i}
                    className="group bg-white p-8 rounded-[2rem] shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden"
                  >
                    <div
                      className={`absolute top-0 right-0 w-24 h-24 bg-${service.color}-500/10 rounded-bl-[4rem] transition-transform duration-500 group-hover:scale-110`}
                    ></div>
                    <div
                      className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-lg bg-${service.color}-600 text-white transform transition-transform duration-500 group-hover:rotate-12`}
                    >
